...
먼저, Colab의 장단점을 알아보자. (참고로, PC 환경은 [딥러닝 개발 환경 구축 한방에 끝내기](https://telegeam.github.io/dev/2020/02/14/dev-dl-setting-local-python/)을 참고하시기 바란다.)
...
* __주의할 점__  
  ...
  - `최대 세션 유지시간은 12시간`이다.
    ...
    + ![세션종료](https://telegeam.github.io/assets/img/dev/ml/2019-08-23-dev-ml-colab-1.jpg)
...
![test폴더](https://telegeam.github.io/assets/img/dev/ml/2019-08-23-dev-ml-colab-2.jpg)   
2. 좌측 상단의 [+새로만들기] 버튼 > 더보기 > `연결할 앱 더보기`를 선택한다.  
![연결할 앱 더보기](https://telegeam.github.io/assets/img/dev/ml/2019-08-23-dev-ml-colab-3.jpg)
...
![연결하기](https://telegeam.github.io/assets/img/dev/ml/2019-08-23-dev-ml-colab-4.jpg)
4. 드라이브 메인화면으로 이동 > 톱니바퀴 모양 버튼 클릭 > `설정`을 클릭한다.  
![설정](https://telegeam.github.io/assets/img/dev/ml/2019-08-23-dev-ml-colab-5.jpg)
5. 새로 뜬 팝업의 좌측 메뉴 앱관리 클릭 > Google Colaboratory 우측의 `기본값으로 사용` 체크박스 클릭 > `완료`를 클릭한다.
![기본값으로 사용](https://telegeam.github.io/assets/img/dev/ml/2019-08-23-dev-ml-colab-6.jpg) 
6. 드라이브 메인화면으로 이동 > 우클릭 > 더보기 > `Google Colaboratory 클릭`
![Google Colaboratory](https://telegeam.github.io/assets/img/dev/ml/2019-08-23-dev-ml-colab-7.jpg)
7. 드디어 `.ipynb` 확장자 파일의 쥬피터 노트북이 등장했다. 파일이름을 클릭하여 test.ipynb로 이름을 변경하자.
8. 상단 메뉴의 도구 > `환경설정`을 클릭한다.  
![환경설정](https://telegeam.github.io/assets/img/dev/ml/2019-08-23-dev-ml-colab-8.jpg)
9. 팝업이 등장한다. 원하는 테마를 선택 후, 체크박스들을 클릭한다.   
![사이트탭](https://telegeam.github.io/assets/img/dev/ml/2019-08-23-dev-ml-colab-9.jpg)
10. (좌측) 편집기 탭 클릭 > 들여쓰기 `4`선택 > 체크박스 2개 체크    
![편집기탭](https://telegeam.github.io/assets/img/dev/ml/2019-08-23-dev-ml-colab-10.jpg)
11. (좌측) 기타 탭 클릭 > 원하는 설정을 적용 > `저장`을 클릭한다.    
![기타탭](https://telegeam.github.io/assets/img/dev/ml/2019-08-23-dev-ml-colab-11.jpg)
  * 참고로 파워레벨을 선택 시, 코딩마다 불꽃이 튀기는 재미가 있다.
  * 아기고양이 모드를 선택 시, 코딩에 지칠 때 고양이들이 위에 튀어나와 근심(?)을 덜어준다.
12. 상단 메뉴 런타임 > 런타임 유형 변경을 클릭한다.
![런타임](https://telegeam.github.io/assets/img/dev/ml/2019-08-23-dev-ml-colab-12.jpg)
13. 런타임 유형은 `Python3`를, 가속기는 `GPU`를 선택 > `저장`을 클릭한다.
![런타임2](https://telegeam.github.io/assets/img/dev/ml/2019-08-23-dev-ml-colab-13.jpg)
14. 아래 그림과 같이 `연결` 버튼을 클릭한다.
![연결](https://telegeam.github.io/assets/img/dev/ml/2019-08-23-dev-ml-colab-14.jpg)
  * 할당중.. > 연결중... > 초기화중.. 으로 텍스트가 변경되며, 최종 `RAM, 디스크 사용량 막대그래프`가 나올 것이다.
15. 아래와 같이 `[>]` 모양의 버튼을 클릭하면, `목차, 코드스니펫, 파일`등의 기능을 활용할 수 있다.  
![팁1](https://telegeam.github.io/assets/img/dev/ml/2019-08-23-dev-ml-colab-15.jpg)
![팁2](https://telegeam.github.io/assets/img/dev/ml/2019-08-23-dev-ml-colab-16.jpg)
...
![Colab테스트](https://telegeam.github.io/assets/img/dev/ml/2019-08-23-dev-ml-colab-17.jpg)
...
## Colab & Markdown  
---
예전 포스팅에서 이미 [마크다운(Markdown) 사용법 및 예제](https://telegeam.github.io/envops/2019/05/22/envops-blog-how-to-use-md/)를 자세히 소개한 바 있다. 이 장에서는 당시 다루지 않은 특히 Colab에 특화된 새로운 마크다운 작성방법 및 단축키에 대하여 설명하겠다. 
