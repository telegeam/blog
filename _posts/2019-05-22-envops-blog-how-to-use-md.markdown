...
* __추천 에디터__  
  + [Prose.io](https://telegeam.github.io/envops/2019/07/04/envops-blog-posting-prose-io/)      
    - 어디서나 접속 가능하다. 
...
```
유형1(`설명어`를 클릭하면 URL로 이동) : [TheoryDB 블로그](https://telegeam.github.io "마우스를 올려놓으면 말풍선이 나옵니다.")  
유형2(URL 보여주고 `자동연결`) : <https://telegeam.github.io>  
...
```
유형1(`이미지` 삽입) :  
![이미지](https://telegeam.github.io/assets/img/think/2019-06-25-think-future-ai-1.png "인공지능")
  
유형2(`사이즈를 조절`하고 싶은 경우 HTML 태그로 처리) :   
<img src="https://telegeam.github.io/assets/img/think/2019-06-25-think-future-ai-1.png" width="300" height="200"> 

유형3(이미지 삽입 후, `링크 걸기`)
[![이미지](https://telegeam.github.io/assets/img/think/2019-06-25-think-future-ai-1.png)](https://telegeam.github.io/think/2019/06/25/think-future-ai/)  
```
...
> __`연습문제2` 정답__   
> 1. [필자의 블로그 Github](https://github.com/theorydb/telegeam.github.io)에 접속  
> 2. 우측의 `Clone or download`(녹색버튼) 클릭  
> 3. `/telegeam.github.io-master/_posts/` 폴더 이동  
...
* __GitHub의 Issue를 이용하는 방법__
  + 일종의 편법인데 GitHub에서 `Issue를 하나 생성`한다.   
    ![이미지1](https://telegeam.github.io/assets/img/envops/2019-07-22-envops-blog-how-to-use-md-1.jpg)
  + Write 탭에 PC에 있는 이미지를 `Drag & Drop`한다. 최종 저장을 안해도 GitHub에 자동으로 업로드가 된다.
    ![이미지2](https://telegeam.github.io/assets/img/envops/2019-07-22-envops-blog-how-to-use-md-2.jpg)
  + 업로드가 다 되면 위 그림과 같은 경로가 생기므로 `해당 URL을 복사해서 사용`한다. 테스트로 복사한 URL로 접속해보았다.
    ![이미지3](https://telegeam.github.io/assets/img/envops/2019-07-22-envops-blog-how-to-use-md-3.jpg)
...
* __GitHub를 이용하는 방법__  
  + 필자가 자주 애용하는 방식이다.
  + 예를 들면 `telegeam.github.io\assets\img\`의 위치에 포스트 계층과 동일하게 폴더를 만들어 `포스트 제목-일련번호`의 형태로 파일을 저장한 후, `https://telegeam.github.io/assets/img/think/2019-06-25-think-future-ai-1.png`와 같은 방식으로 링크를 걸어 활용한다.
